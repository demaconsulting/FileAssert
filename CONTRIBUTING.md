# Contributing to FileAssert

Thank you for your interest in contributing to FileAssert! We welcome contributions from the community and appreciate
...
- **Environment**: Operating system, .NET version, FileAssert version
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/demaconsulting/FileAssert.git
   cd FileAssert
   ```
...
dotnet run --project src/DemaConsulting.FileAssert \
...
FileAssert uses [DemaConsulting.ReqStream][reqstream] for requirements traceability:
...
By contributing to FileAssert, you agree that your contributions will be licensed under the MIT License.

Thank you for contributing to FileAssert!

[code-of-conduct]: https://github.com/demaconsulting/FileAssert/blob/main/CODE_OF_CONDUCT.md
...
[discussions]: https://github.com/demaconsulting/FileAssert/discussions
[issues]: https://github.com/demaconsulting/FileAssert/issues
[security]: https://github.com/demaconsulting/FileAssert/blob/main/SECURITY.md
