...
- **project-name**: FileAssert
- **organization**: DEMA Consulting
- **project-tagline**: File Testing Tool
- **description**: A .NET command-line application for asserting file properties using YAML-defined test suites
- **languages**: C#
- **technologies**: .NET, YamlDotNet, HtmlAgilityPack, PdfPig, System.Xml.Linq, System.Text.Json, xUnit
...
└── test/
    └── DemaConsulting.FileAssert.Tests/
```
