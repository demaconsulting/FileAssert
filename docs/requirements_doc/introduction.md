...
This document contains the requirements for the FileAssert project.

## Purpose

FileAssert is a reference implementation demonstrating best practices for DEMA Consulting
